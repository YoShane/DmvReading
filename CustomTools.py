...
class FunctionGroup:
    ...
    def getAddData(date,sat,div,sec):
        return 'method=add&secDateStr='+date+'&secId='+sec+'&divId='+div+'&dmvNo='+sat+'&licenseTypeCode=3&idNo=L225072148&birthdayStr=0900808&name=%E5%93%88%E5%93%88%E5%93%88&contactTel=0912345678&email=fsafaskf%40gmail.com'
